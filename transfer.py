...
def Send():
	...
	for file in file_list:
		widget = [file.replace(web_queued, ' ') + "\n" + FileIterator(file, ":")]
...
def ShowParameters():
	...
	try:
		...
		widget.append("return")
		parameters.append(widget)
		widget = ("Serial Stopbits\n" + serial_config.get('serial', 'stopbits'))
		widget.append("return")
		parameters.append(widget)
		widget = ("Serial Parity\n" + serial_config.get('serial', 'parity'))
		widget.append("return")
		parameters.append(widget)
		widget = ("Serial H.Shake\n" + serial_config.get('serial', 'xonxoff'))
		widget.append("return")
		parameters.append(widget)
		widget = ("Machine Name\n" + serial_config.get('machine', 'machine_name'))
		widget.append("return")
		parameters.append(widget)
		widget = ("File Extension\n" + serial_config.get('machine', 'file_extension'))
		widget.append("return")
		parameters.append(widget)
